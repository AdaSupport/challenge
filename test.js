...
// Basic test logic:
// I connect 2 clients and make each client perform the same action (adding, completing, finishing)
// then I check whether each client has received the update from the other client's action
describe('server', function() {
    // test task adding capability of server
    ...
    // test task completion capability of server
  ...
  // test task deletion capability of server
